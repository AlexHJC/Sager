...
$(document).ready(function() {
var stickyNavTop='';
if (typeof $('.navbar_fixed').val() !== "undefined") 
{
var stickyNavTop = $('.navbar_fixed').offset().top;	
}
var stickyNav = function(){
var scrollTop = $(window).scrollTop();	 
if (scrollTop > stickyNavTop) { 
$('.navbar_fixed').addClass('navbar_sticky');
} else {
$('.navbar_fixed').removeClass('navbar_sticky'); 
}
};	
...
window.location.replace($base_url+"company/configure_company/"+$netid);
})
});