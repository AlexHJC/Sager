<iframe src="/web/js/plugins/responsivefilemanager/filemanager/dialog.php?type=1&field_id=upload_logo"></iframe>
<input type="text" class="form-control" value="7" id="upload_logo">
