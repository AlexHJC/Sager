...
<div class="certificates-update">
	...
	<div class="certificates-form">
        ...
        <div class="row attach_sp">
            ...
            <div class="col-md-4">
                <label class="control-label">Add to Products List</label>
                <div class="clear"></div>
                <span id="add_prod" class="btn btn-success">+</span>
            </div>
            <div class="col-md-4">
            </div>
            <div class="col-md-12">
                <div class="table-responsive table-widget">
                    ...
                    <table id="table_products_add" class="table table-bordered table-striped">
                        <tr>
                            <th><i class="fa fa-tasks fa-fw"></i> Title EN</th>
                            <th>Title FR</th>
                            <th>Action</th>
                        </tr>
                        <tr class="hidden">
            ...
            <div class="col-md-4">
                <div class="attach_sp_certif">
                    <?=$form->field($model, 'attachment')->widget(\mihaildev\elfinder\InputFile::className(), [
                        ...
                        'template'      => '<div class="input-group atach_sp">{input}<span class="input-group-btn">{button}</span><span class="btn btn-success" id="addAtachBtn">+</span></div>',
	    ...
	    <div class="form-group">
            ...
            <div class="error_text">
                <?=Yii::t('form', 'It is necessary to add minimum one product *');?>
            </div>
	    </div>
